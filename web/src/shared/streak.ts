// Daily-race streaks count consecutive UTC calendar days. Race results
// store finished_at as epoch ms; UTC keeps two players in opposite
// timezones agreeing on whether the same race counted toward "today".
