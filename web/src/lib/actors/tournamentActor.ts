...
/**
 * WS actor for the bracket viewer. Sends a HEARTBEAT every 25 s; the
 * server's TTL is 60 s so a single dropped beat is recoverable. Parent
 * re-invokes this actor to reconnect.
 */
