...
export class RoomRepo {
  ...
  /**
   * Atomically transition lobby → countdown and stamp `started_at`.
   * Returns the started_at written. Throws Conflict if already started.
   */
  ...
  async recordFinish(input: RecordFinishInput): Promise<void> {
    ...
    try {
      ...
      // already finished — record idempotently below
    }
