...
// http/reviewSnippet.ts
var Body = external_exports.object({ reason: external_exports.string().max(280).optional() }).passthrough();
var handler = withHttp(Body, async (input, ctx) => {
  requireAdmin(ctx);
