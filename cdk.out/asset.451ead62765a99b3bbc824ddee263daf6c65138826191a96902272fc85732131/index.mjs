...
// ../node_modules/.bun/uuid@10.0.0/node_modules/uuid/dist/esm-node/v7.js
var _seqLow = null;
var _seqHigh = null;
var _msecs = 0;
...
var SnippetRepo = class {
  constructor(client2 = ddb, rng2 = Math.random) {
    this.client = client2;
    this.rng = rng2;
  }
...
async function resolveSetup(input) {
  if (input.previous_room_id) {
    ...
    const seedPlayers = prevPlayers.filter((p) => !p.is_dnf).map((p) => ({
